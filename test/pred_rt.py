...
# Pred RT
rt_df = molnet_engine.pred_rt(path_to_results='./test/output_rt.csv', path_to_checkpoint='./src/molnetpack/check_point/molnet_v1.2_rt_etkdgv3_tl.pt')
# rt_df = molnet_engine.pred_rt(
#     path_to_results="./test/output_rt.csv"
